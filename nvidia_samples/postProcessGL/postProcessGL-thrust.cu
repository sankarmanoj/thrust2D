...
{
cudaProcessFunctor(unsigned int *g_odata, int imgw, int imgh,int tilew, int r, float threshold, float highlight)
{

}
__device__ operator() (thrust::window_2d<unsigned int> input, thrust::window_2d<unsigned int> output)
{
...
launch_cudaProcess(dim3 grid, dim3 block, int sbytes,
                   unsigned int *g_data_array, unsigned int *g_odata,
