...
using namespace cv;
class erodeFunctor //: public thrust::shared_unary_window_transform_functor<float>
{
  public:
...
int main(int argc, char const *argv[]) {
  ...
  thrust::transform(thrust::host,myVector.begin(),myVector.end(),outputVector.begin(),null_block.begin(),erodeFunctor());
