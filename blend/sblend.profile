==6852== NVPROF is profiling process 6852, command: ./sblend.o
==6852== Some kernel(s) will be replayed on device 0 in order to collect all events/metrics.
==6852== Profiling application: ./sblend.o
