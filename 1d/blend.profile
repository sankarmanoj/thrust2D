==10522== NVPROF is profiling process 10522, command: ./blend.o
==10522== Some kernel(s) will be replayed on device 0 in order to collect all events/metrics.
==10522== Profiling application: ./blend.o
==10522== Profiling result:
==10522== Metric result:
