...
LK    Kernel: void thrust::for_each_kernel<thrust::detail::normal_iterator<thrust::device_ptr<int>>, ind_calcYOYOYOYO>(long, int, thrust::device_ptr<int>)
...
NW    Kernel: void thrust::for_each_kernel<thrust::detail::normal_iterator<thrust::device_ptr<double>>, update_uYOYOYOYO>(long, double, thrust::device_ptr<double>)
        999                         branch_efficiency                         Branch Efficiency     100.00%     100.00%     100.00%
        999                            gld_efficiency             Global Memory Load Efficiency     100.00%     100.00%     100.00%
        999                            gst_efficiency            Global Memory Store Efficiency     100.00%     100.00%     100.00%
        999                         shared_efficiency                  Shared Memory Efficiency      78.12%      78.12%      78.12%
        999                        shared_utilization                 Shared Memory Utilization     Low (1)     Low (1)     Low (1)
LK/NW    Kernel: void thrust::for_each_kernel<thrust::detail::normal_iterator<thrust::device_ptr<double>>, normalize_weightsYOYOYOYO>(long, double, thrust::device_ptr<double>)
...
SUM  Kernel: void thrust::better_reduce_kernel<double, unsigned int=32>(double*, double, unsigned int)
        999                         branch_efficiency                         Branch Efficiency     100.00%     100.00%     100.00%
        999                            gld_efficiency             Global Memory Load Efficiency     100.00%     100.00%     100.00%
