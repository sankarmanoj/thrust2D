==25913== NVPROF is profiling process 25913, command: ./shared_boxfilter.o
==25913== Some kernel(s) will be replayed on device 0 in order to collect all events/metrics.
==25913== Profiling application: ./shared_boxfilter.o
...
Device "GeForce GTX 1070 (0)"
    Kernel: void thrust::conv_shared_Kernel<float>(float const *, float const , thrust::conv_shared_Kernel<float>*, int, int)
          ...
          1                        shared_utilization                 Shared Memory Utilization     Mid (5)     Mid (5)     Mid (5)
