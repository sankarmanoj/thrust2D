...
namespace thrust
{
  ...
  {
    void  generate_launcher_config(Iterator begin,Iterator end)
      {
        ...
        mConfiguration.blocks = ceil((float)mConfiguration.total_operations/mConfiguration.operations_per_block);
