...
namespace thrust
{
	...
	template<class T>
	class block_iterator : public thrust::detail::normal_iterator<thrust::device_ptr<T> >
	{
	public:
		Block_2D<T> *b;
		...
		__host__ __device__ thrust::detail::normal_iterator<thrust::device_ptr<T> > operator[] (unsigned int index);
		__host__ __device__ const thrust::detail::normal_iterator<thrust::device_ptr<T> > operator[] (unsigned int index) const;
		__host__ __device__ thrust::detail::normal_iterator<thrust::device_ptr<T> > operator* ();
    __host__ __device__ const thrust::detail::normal_iterator<thrust::device_ptr<T> > operator* () const;
