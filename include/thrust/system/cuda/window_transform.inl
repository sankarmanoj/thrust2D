...
namespace thrust
{
  ...
  void transform(cuda::texture_policy,Iterator begin1, Iterator end1, Iterator begin2, Iterator begin3, Func f)
  {
    ...
    transform_texture_kernel<<<dim3(iDivUp(begin1.block_dim_x,mConfiguration.warp_size),iDivUp(begin1.block_dim_y,mConfiguration.warp_size),1),dim3(mConfiguration.warp_size,mConfiguration.warp_size,1)>>>(texref1,texref2,begin3,mConfiguration,f);
  }
  ...
  void transform(cuda::texture_policy,Iterator begin1, Iterator end1, Iterator begin2, Func f)
  {
    ...
    transform_texture_kernel<<<dim3(iDivUp(begin1.block_dim_x,mConfiguration.warp_size),iDivUp(begin1.block_dim_y,mConfiguration.warp_size),1),dim3(mConfiguration.warp_size,mConfiguration.warp_size,1)>>>(texref,begin2,mConfiguration,f);
  }
